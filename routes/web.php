...
Route::get('laporan',[Masyarakatcontroller::class,'laporan'])->middleware(ValidasiAdmin::class,cekAdmin::class);
Route::get('tanggapin',[AdminController::class,'tanggapin'])->middleware(ValidasiAdmin::class);
Route::post('tanggapin',[AdminController::class,'simpenin']);
